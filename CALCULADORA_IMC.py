...
l_resultado_texto = Label(frame_baixo, width=1, text="", height=5, padx=8, pady=8, relief="flat", anchor="center", font=('Ivy 10 bold'), bg=co2, fg=co0)
l_resultado_texto.place(x=290, y=100)
...
b_calcular.grid(row=5, column=0,  sticky=NSEW, pady=3, padx=1, columnspan=12)
